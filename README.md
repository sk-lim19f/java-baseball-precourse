...
### 정답 시 게임 종료 (단, 게임 재시작 가능)

- 게임을 새로 시작하려면 1을 입력한다.
- 게임을 종료하려면 2을 입력한다.

### 예외 처리

- 사용자가 잘못된 값을 입력할 경우 `IllegalArgumentException` 을 발생시킨 후 게임을 종료한다.
  - 사용자가 입력한 숫자가 3자리가 아닐 경우
  - 사용자가 입력한 값이 숫자가 아닐 경우
